...
import Com.Spacefinders.Utility.Hashing;
...
public class UserService {
    ...
    public UserResponse addUser(UserSignupRequest request) {
        ...
        user.setPassword(Hashing.encryptPassword(request.getPassword()));
    ...
    public LoginResponse loginUser(UserLoginRequest request) {
        ...
        if (!Hashing.decryptPassword(request.getPassword(), user.getPassword())) {
    ...
    public UserResponse forgotPassword(String userName, String newPassword){
        ...
        if(Hashing.decryptPassword(newPassword, user.getPassword())){
        ...
        user.setPassword(Hashing.encryptPassword(newPassword));
    ...
    public void resetPassword(ResetPasswordRequest request) {
        ...
        if (Hashing.decryptPassword(request.getOldPassword(), user.getPassword())) {
        ...
        // Update password
        user.setPassword(Hashing.encryptPassword(request.getNewPassword()));
        userRepository.save(user);
