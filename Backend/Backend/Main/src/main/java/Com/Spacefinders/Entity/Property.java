...
public class Property {
    ...
    @Column(nullable = false)
    private PropertyStatus propertyStatus;// AVAILABLE,
    ...
    @Column(nullable = false)
    private Integer propertyAccountNumber;
    ...
    public Property(Integer propertyId, String propertyName, String propertyDescription,
                    ...
                    Double pricePerDay, Integer userId, String imageURL, Integer addressId,
                    ...
                    Double propertyRate, Integer propertyRatingCount, Integer propertyAccountNumber) {
    ...
    public Integer getPropertyAccountNumber() {
        return propertyAccountNumber;
    }

    public void setPropertyAccountNumber(Integer propertyAccountNumber) {
        this.propertyAccountNumber = propertyAccountNumber;
    }
}