...
import Com.Spacefinders.DTO.Request.PaymentRequest;
...
public class ClientController {
    ...
    public ResponseEntity<ApiResponse<PropertyDetailResponse>> viewClickedProperty(@PathVariable int propertyId) {
    ...
    public ResponseEntity<ApiResponse<List<BookingResponse>>> viewBooking(@PathVariable int userId) {
...
//    public ResponseEntity<ApiResponse<String>> cancelBooking(@PathVariable int bookingId) {
...
//    }
    ...
    @PostMapping("/alwaysTrue")
    public boolean alwaysTrue(@RequestBody PaymentRequest paymentRequest){
        return clientService.makePayment(paymentRequest);
    }
}