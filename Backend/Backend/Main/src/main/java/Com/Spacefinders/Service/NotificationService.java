...
public class NotificationService {
   ...
   //Send notifications
    ...
    public List<NotificationResponse> sendNotification(NotificationRequest request) {
        System.out.println("getNotificationTitle: " + request.getNotificationTitle() + " getNotificationMessage: " + request.getNotificationMessage() + " getNotificationType: " + request.getNotificationType() + " getNotificationTarget: " + request.getNotificationTarget() + " getUserId: " + request.getUserId());
